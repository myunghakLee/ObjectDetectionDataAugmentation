...
if __name__ == '__main__':
    ...
    if dir2save is None:  #opt.mode가 잘못된 경우
        ...
        try:
            ...
            pass
        if opt.mode == 'random_samples':
            real = functions.read_image(opt) # opt.input_dir 과 opt.input_name을 이용하여 이미지를 array형식으로 받아옴
            ...
            Gs, Zs, reals, NoiseAmp = functions.load_trained_pyramid(opt) # 총 4개의 모델을 불러옴
